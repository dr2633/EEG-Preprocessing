...
stim = 'Jobs2'
seg = 'segment_2'
comp = 'no-ica1'  # two options: 'no-ica' or 'with-ica'
...
# Plot in terminal and check raw channels
# raw.plot()
...
word_epochs = mne.Epochs(raw_zscored, word_events, tmin=-0.1, tmax=0.3, baseline=None, reject=None, flat=None)
